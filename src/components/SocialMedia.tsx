...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/in/pierre-pariente-97835742', icon: LinkedinIcon },
  { title: 'GitHub', href: 'https://github.com/PierreParienteDimitrov', icon: GitHubIcon },
  { title: 'Dribbble', href: 'https://dribbble.com/Pariente', icon: DribbbleIcon },
]
